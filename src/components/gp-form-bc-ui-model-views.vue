<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['model'])">
                <el-input
                    v-model="dataForm.__data__['model'].name"
                    @change="m2o_cache(dataForm, 'model')"
                    :readonly="readonly('model')"
                >
                    <template v-if="isCompute('model')" #prefix>
                    ...
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('model', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                        ...
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['model'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('model', dataForm.__data__['model'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['model'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('model', dataForm.__data__['model'].id)"
                        ></el-button>
                    </template>
                </el-input>					

		</el-form-item>
		<el-form-item :label="t(colsLabel['vtype'])">
                <el-input
                    v-model="dataForm.__data__['vtype'].name"
                    @change="m2o_cache(dataForm, 'vtype')"
                    :readonly="readonly('vtype')"
                >
                    <template v-if="isCompute('vtype')" #prefix>
                        <el-button type="primary" size="mini" icon="el-icon-s-data" />
                    </template>
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('vtype', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                        ...
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['vtype'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('vtype', dataForm.__data__['vtype'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['vtype'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('vtype', dataForm.__data__['vtype'].id)"
                        ></el-button>
                    </template>
                </el-input>					

		</el-form-item>
		<el-form-item :label="t(colsLabel['standalone'])">
                <el-switch
                    v-model="dataForm.__data__['standalone']"
                    @change="cache(dataForm, 'standalone')"
                    :disabled="readonly('standalone')"
                ></el-switch>

		</el-form-item>
		<el-form-item :label="t(colsLabel['template'])">
                <el-input v-model="dataForm.__data__['template']" autosize type="textarea"
                    @change="cache(dataForm, 'template')" :readonly="readonly('template')">
                 </el-input>

		</el-form-item>
		<el-form-item :label="t(colsLabel['script'])">
                <el-input v-model="dataForm.__data__['script']" autosize type="textarea"
                    @change="cache(dataForm, 'script')" :readonly="readonly('script')">
                 </el-input>

		</el-form-item>
		<el-form-item :label="t(colsLabel['style'])">
                <el-input v-model="dataForm.__data__['style']" autosize type="textarea"
                    @change="cache(dataForm, 'style')" :readonly="readonly('style')">
                 </el-input>

		</el-form-item>
		<el-form-item :label="t(colsLabel['i18n'])">
                <el-input v-model="dataForm.__data__['i18n']" autosize type="textarea"
                    @change="cache(dataForm, 'i18n')" :readonly="readonly('i18n')">
                 </el-input>

		</el-form-item>
		<el-form-item :label="t(colsLabel['scoped'])">
                <el-switch
                    v-model="dataForm.__data__['scoped']"
                    @change="cache(dataForm, 'scoped')"
                    :disabled="readonly('scoped')"
                ></el-switch>

		</el-form-item>
		<el-form-item :label="t(colsLabel['sfc'])">
                <el-input v-model="dataForm.__data__['sfc']" autosize type="textarea"
                    @change="cache(dataForm, 'sfc')" :readonly="readonly('sfc')">
                 </el-input>
...
export default defineComponent({
    name: 'gp-form-bc-ui-model-views',
})
