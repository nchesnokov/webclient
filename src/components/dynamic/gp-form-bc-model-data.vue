<template>
    ...
    <slot>
		...
		<el-form-item :label="colsLabel['module']">
                <el-input
		...
		<el-form-item :label="colsLabel['model']">
                <el-input
		...
		<el-form-item :label="colsLabel['rec_id']">
                <el-input
		...
		<el-form-item :label="colsLabel['file_id']">
                <el-input
                    v-model="dataForm.__data__['file_id'].name"
                    v-if="colsType['file_id'] == 'related'"
		...
		<el-form-item :label="colsLabel['date_init']">
                <el-date-picker
		...
		<el-form-item :label="colsLabel['date_update']">
                <el-date-picker
