<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['country'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['ispeople'])">
                <el-switch
		...
		<el-form-item :label="t(colsLabel['iscustomer'])">
                <el-switch
		...
		<el-form-item :label="t(colsLabel['issuplier'])">
                <el-switch
		...
		<el-form-item :label="t(colsLabel['vat_number'])">
                <el-input
                    v-model="dataForm.__data__['vat_number']"
                    :maxlength="colsSize['vat_number']"
                    show-word-limit
                    @change="cache(dataForm, 'vat_number')"
                    :readonly="readonly('vat_number')"
                >
                    <template v-if="isCompute('vat_number')" #prepend>
                        <el-button type="primary" size="small" :icon="Monitor" />
                        <el-dropdown v-if="colsTranslate['vat_number']" @command="i18nCommand">
                            <span class="el-dropdown-link">
                                {{ colsLang['vat_number'].toLowerCase() }}
                                <i
                                    class="el-icon-arrow-down el-icon--right"
                                ></i>
                            </span>
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <el-dropdown-item
                                        v-for="lang in $UserPreferences.langs"
                                        :key="lang.code"
                                        :command="{ col: 'vat_number', lang: lang.code }"
                                    >{{ lang.description }}</el-dropdown-item>
                                </el-dropdown-menu>
                            </template>
                        </el-dropdown>
		...
		<el-form-item :label="t(colsLabel['vat_reason'])">
                <el-select
                    v-model="dataForm.__data__['vat_reason']"
                    @change="cache(dataForm, 'vat_reason')"
                    :disabled="readonly('vat_reason')"
                >
                    <el-option
                        v-for="item in selOptions['vat_reason']"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                    ></el-option>
		...
		<el-form-item :label="t(colsLabel['latitude'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['longitude'])">
                <el-input
