<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['street'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['street2'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['zip'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['city'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['country_id'])">
                <el-input
                    v-model="dataForm.__data__['country_id'].name"
                    @change="m2o_cache(dataForm, 'country_id')"
                    :readonly="readonly('country_id')"
                >
                    <template v-if="isCompute('country_id')" #prefix>
                    ...
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('country_id', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('country_id')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['country_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('country_id', dataForm.__data__['country_id'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['country_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('country_id', dataForm.__data__['country_id'].id)"
                        ></el-button>
                    </template>
                </el-input>					

		</el-form-item>
		<el-form-item :label="t(colsLabel['state_id'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['email'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['phone'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['bic'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['inactive'])">
                <el-switch
