<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['descr'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['momi'])">
				<JsonViewer :value="dataForm.__data__['momi']" copyable boxed sort theme="jv-light"/>
...
export default defineComponent({
    name: 'gp-form-bc-model-inherits',
})
...
de:
  ...
  Meta Of Model Inherit: Meta Of Model Inherit
  Models: Models
  Module: Module
  Name: Name
en:
