<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['label'])">
                <el-input
                    v-model="dataForm.__data__['label']"
                    :maxlength="colsSize['label']"
                    show-word-limit
                    @change="cache(dataForm, 'label')"
                    :readonly="readonly('label')"
                >
                    <template v-if="isCompute('label')" #prepend>
                        <el-button type="primary" size="small" :icon="Monitor" />
                        <el-dropdown v-if="colsTranslate['label']" @command="i18nCommand">
                            <span class="el-dropdown-link">
                                {{ colsLang['label'].toLowerCase() }}
                                <i
                                    class="el-icon-arrow-down el-icon--right"
                                ></i>
                            </span>
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <el-dropdown-item
                                        v-for="lang in $UserPreferences.langs"
                                        :key="lang.code"
                                        :command="{ col: 'label', lang: lang.code }"
                                    >{{ lang.description }}</el-dropdown-item>
                                </el-dropdown-menu>
                            </template>
                        </el-dropdown>
		...
		<el-form-item :label="t(colsLabel['parent_id'])">
                <el-input
                    v-model="dataForm.__data__['parent_id'].name"
                    @change="m2o_cache(dataForm, 'parent_id')"
                    :readonly="readonly('parent_id')"
                >
                    <template v-if="isCompute('parent_id')" #prefix>
                    ...
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('parent_id', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('parent_id')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['parent_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('parent_id', dataForm.__data__['parent_id'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['parent_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('parent_id', dataForm.__data__['parent_id'].id)"
                        ></el-button>
                    </template>
                </el-input>					
		...
		<el-form-item :label="t(colsLabel['action_id'])">
                <el-input
                    v-model="dataForm.__data__['action_id'].name"
                    @change="m2o_cache(dataForm, 'action_id')"
                    :readonly="readonly('action_id')"
                >
                    <template v-if="isCompute('action_id')" #prefix>
                        <el-button type="primary" size="mini" icon="el-icon-s-data" />
                    </template>
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('action_id', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('action_id')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['action_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('action_id', dataForm.__data__['action_id'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['action_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('action_id', dataForm.__data__['action_id'].id)"
                        ></el-button>
                    </template>
                </el-input>					
...
export default defineComponent({
    name: 'gp-form-bc-ui-model-menus',
})
