        ...
        <el-form :model="form">
            <el-form-item label="Framework" :label-width="formLabelWidth">
                <el-select v-model="form.framework" autocomplete="on">
                    <el-option
                        v-for="item in $UserPreferences.frameworks"
                        :key="item.code"
                        :label="item.descr"
                        :value="item.code"
                    ></el-option>
            ...
            <el-form-item label="Language" :label-width="formLabelWidth">
                <el-select v-model="form.language" autocomplete="on">
                    <el-option
                        v-for="item in $UserPreferences.langs"
                        :key="item.code"
            ...
            <el-form-item label="Country" :label-width="formLabelWidth">
                <el-select v-model="form.country">
                    <el-option
                        v-for="k,v in $UserPreferences.country_names"
                        :key="v"
                        :label="k"
                        :value="v"
                    ></el-option>
            ...
            >
                <el-select v-model="form.timezone">
                    <el-option
                        v-for="k in $UserPreferences.country_timezones[form.country]"
                        :key="k"
                        :label="k"
                        :value="k"
                    ></el-option>
