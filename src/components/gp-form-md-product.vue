<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['template_id'])">
                <el-input
                    v-model="dataForm.__data__['template_id'].name"
                    @change="m2o_cache(dataForm, 'template_id')"
                    :readonly="readonly('template_id')"
                >
                    <template v-if="isCompute('template_id')" #prefix>
                    ...
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('template_id', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('template_id')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['template_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('template_id', dataForm.__data__['template_id'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['template_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('template_id', dataForm.__data__['template_id'].id)"
                        ></el-button>
                    </template>
                </el-input>					
		...
		<el-form-item :label="t(colsLabel['gti'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['volume'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['volume_uom'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['weight'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['weight_uom'])">
                <el-input
		...
		<el-form-item :label="t(colsLabel['qrcode'])">
		...
		<el-form-item :label="t(colsLabel['link'])">
                <el-input
                    v-model="dataForm.__data__['link']"
                    :maxlength="colsSize['link']"
                    show-word-limit
                    @change="cache(dataForm, 'link')"
                    :readonly="readonly('link')"
                >
                    <template v-if="isCompute('link')" #prepend>
                        <el-button type="primary" size="small" :icon="Monitor" />
                        <el-dropdown v-if="colsTranslate['link']" @command="i18nCommand">
                            <span class="el-dropdown-link">
                                {{ colsLang['link'].toLowerCase() }}
                                <i
                                    class="el-icon-arrow-down el-icon--right"
                                ></i>
                            </span>
                            <template #dropdown>
                                <el-dropdown-menu>
                                    <el-dropdown-item
                                        v-for="lang in $UserPreferences.langs"
                                        :key="lang.code"
                                        :command="{ col: 'link', lang: lang.code }"
                                    >{{ lang.description }}</el-dropdown-item>
                                </el-dropdown-menu>
                            </template>
                        </el-dropdown>
