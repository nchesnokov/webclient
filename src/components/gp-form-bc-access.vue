<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['group_id'])">
                <el-input
                    v-model="dataForm.__data__['group_id'].name"
                    @change="m2o_cache(dataForm, 'group_id')"
                    :readonly="readonly('group_id')"
                >
                    <template v-if="isCompute('group_id')" #prefix>
                    ...
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('group_id', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('group_id')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['group_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('group_id', dataForm.__data__['group_id'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['group_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('group_id', dataForm.__data__['group_id'].id)"
                        ></el-button>
                    </template>
                </el-input>					
