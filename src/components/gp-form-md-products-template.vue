<template>
    ...
    <slot>
		...
		<el-form-item :label="colsLabel['mtype']">
                <el-select
                    v-model="dataForm.__data__['mtype']"
                    @change="cache(dataForm, 'mtype')"
                    :disabled="readonly('mtype')"
                >
                    <el-option
                        v-for="item in selOptions['mtype']"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                    ></el-option>
...
export default defineComponent({
    name: 'gp-form-md-products-template',
})
