<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['framework'])">
                <el-input
                    v-model="dataForm.__data__['framework'].name"
                    @change="m2o_cache(dataForm, 'framework')"
                    :readonly="readonly('framework')"
                >
                    <template v-if="isCompute('framework')" #prefix>
                    ...
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('framework', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('framework')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['framework'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('framework', dataForm.__data__['framework'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['framework'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('framework', dataForm.__data__['framework'].id)"
                        ></el-button>
                    </template>
                </el-input>					
		...
		<el-form-item :label="t(colsLabel['exclude'])">
				<JsonViewer :value="dataForm.__data__['exclude']" copyable boxed sort theme="jv-light"/>
...
export default defineComponent({
    name: 'gp-form-bc-ui-view-model-types',
})
