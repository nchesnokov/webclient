<template>
    ...
    <slot>
		...
		<el-form-item :label="colsLabel['subtype_vat']">
                <el-select
                    v-model="dataForm.__data__['subtype_vat']"
                    @change="cache(dataForm, 'subtype_vat')"
                    :disabled="readonly('subtype_vat')"
                >
                    <el-option
                        v-for="item in selOptions['subtype_vat']"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                    ></el-option>
		...
		<el-form-item :label="colsLabel['value']">
                <el-input
                    v-model="dataForm.__data__['value']"
                    @change="cache(dataForm, 'value')"
                    :readonly="readonly('value')"
                >
                    <template v-if="isCompute('value')" #prefix>
                        <el-button type="primary" size="small" :icon="Monitor" />
                    </template>
                </el-input>

		</el-form-item>
		<el-form-item :label="colsLabel['type_vat']">
                <el-select
                    v-model="dataForm.__data__['type_vat']"
                    @change="cache(dataForm, 'type_vat')"
                    :disabled="readonly('type_vat')"
                >
                    <el-option
                        v-for="item in selOptions['type_vat']"
                        :key="item.value"
                        :label="item.label"
                        :value="item.value"
                    ></el-option>
