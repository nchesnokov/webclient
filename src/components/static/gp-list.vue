...
<el-container>
    <el-table :data="tableDataDisplay" style="width: 100%">
            ...
            <template #default="props">
                <el-tabs type="border-card" v-if="o2mcols.length > 0">
                    <el-tab-pane :label="colsLabel[o2mcol]" v-for="o2mcol in o2mcols" :key="o2mcol">
                        <gp-list :metas="metas" :model="metas[model].meta.columns[o2mcol].obj" :tableData="props.row[o2mcol]" />
                    </el-tab-pane>
                </el-tabs>
            </template>
        </el-table-column>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const tableDataDisplay = computed(() => {
            ...
            if (props.tableData === null || props.tableData.length === 0) return reactive([])
            else return props.tableData.slice(pageSize.value * page.value - pageSize.value, pageSize.value * page.value)
        })
