<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['view'])">
                <el-input
                    v-model="dataForm.__data__['view'].name"
                    @change="m2o_cache(dataForm, 'view')"
                    :readonly="readonly('view')"
                >
                    <template v-if="isCompute('view')" #prefix>
                    ...
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('view', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                        ...
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['view'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('view', dataForm.__data__['view'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['view'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('view', dataForm.__data__['view'].id)"
                        ></el-button>
                    </template>
                </el-input>					

		</el-form-item>
		<el-form-item :label="t(colsLabel['tuser'])">
                <el-input
                    v-model="dataForm.__data__['tuser'].name"
                    @change="m2o_cache(dataForm, 'tuser')"
                    :readonly="readonly('tuser')"
                >
                    <template v-if="isCompute('tuser')" #prefix>
                        <el-button type="primary" size="mini" icon="el-icon-s-data" />
                    </template>
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('tuser', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                        ...
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['tuser'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('tuser', dataForm.__data__['tuser'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['tuser'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('tuser', dataForm.__data__['tuser'].id)"
                        ></el-button>
                    </template>
                </el-input>					

		</el-form-item>
		<el-form-item :label="t(colsLabel['values'])">
				<JsonViewer :value="dataForm.__data__['values']" copyable boxed sort theme="jv-light"/>
...
export default defineComponent({
    name: 'gp-form-bc-tuning-ui-model-views',
})
