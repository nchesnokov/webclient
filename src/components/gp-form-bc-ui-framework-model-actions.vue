<template>
    ...
    <slot>
		...
		<el-form-item :label="t(colsLabel['framework_id'])">
                <el-input
                    v-model="dataForm.__data__['framework_id'].name"
                    @change="m2o_cache(dataForm, 'framework_id')"
                    :readonly="readonly('framework_id')"
                >
                    <template v-if="isCompute('framework_id')" #prefix>
                        <el-button type="primary" size="mini" icon="el-icon-s-data" />
                    </template>
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('framework_id', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('framework_id')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['framework_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('framework_id', dataForm.__data__['framework_id'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['framework_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('framework_id', dataForm.__data__['framework_id'].id)"
                        ></el-button>
                    </template>
                </el-input>					

		</el-form-item>
		<el-form-item :label="t(colsLabel['view_id'])">
                <el-input
                    v-model="dataForm.__data__['view_id'].name"
                    @change="m2o_cache(dataForm, 'view_id')"
                    :readonly="readonly('view_id')"
                >
                    <template v-if="isCompute('view_id')" #prefix>
                        <el-button type="primary" size="mini" icon="el-icon-s-data" />
                    </template>
                    <template #suffix>
                        <el-button
                            ...
                            size="small"
                            :icon="Search"
                            @click="do_find('view_id', 'single', [], { 'item': dataForm })"
                        ></el-button>
                        <el-button
                            type="primary"
                            size="small"
                            :icon="DocumentAdd"
                            @click="do_add('view_id')"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['view_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="Edit"
                            @click="do_edit('view_id', dataForm.__data__['view_id'].id)"
                        ></el-button>
                        <el-button
                            v-if="dataForm.__data__['view_id'].id != null"
                            type="primary"
                            size="small"
                            :icon="View"
                            @click="do_lookup('view_id', dataForm.__data__['view_id'].id)"
                        ></el-button>
                    </template>
                </el-input>					
...
export default defineComponent({
    name: 'gp-form-bc-ui-framework-model-actions',
})
